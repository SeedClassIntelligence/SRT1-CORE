...
7. FileCell is a local containment concept, not a private-runtime-only concept.
...
12. Core does not ship private Seed Signature authority, private keys, SCIA memory implementation, SCIA security implementation, SION internals, private audit chain, or proprietary team/cloud backend.
13. Private/external integrations are optional and must fail closed when unavailable.
...
- A file is not private merely because it mentions private/external integration boundaries.
