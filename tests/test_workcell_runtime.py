...
class WorkCellRuntimeTests(unittest.TestCase):
    ...
    def test_dashboard_contains_workcell_operations_surface(self):
        ...
        self.assertIn("Conversation Trace", html)
        self.assertIn("workcellChatList", html)
        self.assertNotIn('id="workcellChatInput"', html)
        self.assertNotIn("data-workcell-chat-send", html)
        self.assertIn("loadWorkCellMessages", html)
        self.assertNotIn("function sendWorkCellChat", html)
        self.assertIn("/messages?limit=50", html)
        self.assertIn("Open WorkCell in Standard Experience", html)
        self.assertIn("Read-only continuity record", html)
        ...
        self.assertNotIn("data-proposal-review", html)
        self.assertNotIn("data-proposal-apply", html)
        ...
        self.assertNotIn('data-workcell-action="cancel"', html)
        self.assertNotIn('data-workcell-action="stop"', html)
        self.assertIn("validate-writes", html)
        self.assertIn("/ack", html)
        self.assertNotIn("data-workcell-assistant-run", html)
        ...
        self.assertNotIn("data-workcell-verify", html)
        ...
        self.assertNotIn("data-provider-result-action", html)
