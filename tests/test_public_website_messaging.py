...
class PublicWebsiteMessagingTests(unittest.TestCase):
    def test_srt1_core_homepage_centers_idea_to_completion_lifecycle(self):
        ...
        self.assertIn('<section id="workspaceView" class="view active"', experience)
        ...
        self.assertIn("Connect Project", experience)
        self.assertIn("Previous Work", experience)
        ...
        self.assertIn("Seed captured for this project conversation.", experience)
