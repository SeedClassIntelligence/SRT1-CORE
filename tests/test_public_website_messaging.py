...
class PublicWebsiteMessagingTests(unittest.TestCase):
    def test_srt1_core_homepage_centers_idea_to_completion_lifecycle(self):
        ...
        self.assertIn("What would you like to accomplish today?", front_door)
        self.assertIn("Start with an Idea", front_door)
        self.assertIn("Open Existing Project", front_door)
        self.assertIn("Continue Previous Work", front_door)
        ...
        self.assertIn("Project Workspace", experience)
